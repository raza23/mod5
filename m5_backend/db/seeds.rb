...
#! USERS
test1 = User.create(name: 'test',username: 'test',password:'test',user_type: 'admin')
...
#! ORGANIZATION
mass = Organization.create(name: 'MASS Clinic',username: 'mass', password: 'mass', category: 'Healthcare', description: 'MASS Clinic provides free, volunteer-based care management to the uninsured population of Duval County.', site: 'https://massclinic.org/')
...
# ! OPPURTUNITY
o1 = Oppurtunity.create(organization: mass,volunteers_needed: 2, description: 'Volunteer will come and document vitals of patients', date: '8/06/2020')
o2 = Oppurtunity.create(organization: mass,volunteers_needed: 2, description: 'Volunteer will come and document vitals of patients', date: '8/06/2020')
o3 = Oppurtunity.create(organization: mass,volunteers_needed: 2, description: 'Volunteer will come and document vitals of patients', date: '8/16/2020')
o4 = Oppurtunity.create(organization: mass,volunteers_needed: 2, description: 'Volunteer will come and document vitals of patients', date: '8/16/2020')

# o5 = Oppurtunity.create(organization: feeding,volunteers_needed: 2, description: 'Help pack meals with us', date: '5/17/2020')
# o6 = Oppurtunity.create(organization: feeding,volunteers_needed: 2, description: 'Help pack meals with us', date: '5/18/2020')
# o7 = Oppurtunity.create(organization: feeding,volunteers_needed: 2, description: 'Help pack meals with us', date: '5/19/2020')
# o8 = Oppurtunity.create(organization: feeding,volunteers_needed: 2, description: 'Help pack meals with us', date: '5/20/2020')
...
l1 = Log.create(clockin: '1:00 pm', clockout: '2:00 pm',oppurtunity: o1,user: raza,confirmed: false)
l2 = Log.create(clockin: '1:00 pm', clockout: '2:00 pm',oppurtunity: o2,user: goku,confirmed: true)
