      ...
      <div>
        ...
        <Switch>
          ...
          <Route
            exact
            path="/login_user"
            render={() => <AuthForm onChangeUser={this.onChangeUser} />}
          />
          <Route
            exact
            path="/login_org"
            render={() => <AuthFormOrg onChangeUser={this.onChangeUser} />}
          />
          {/* <Route
        ...
        /> */}
          ...
          <Route
            ...
            path="/logs"
            render={() => (
              <LogList logs={this.state.logs} user={this.state.currentUser} />
            )}
          />
          <Route
            path="/Home"
